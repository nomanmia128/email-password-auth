...
const SignUp = () => {
    ...
    const handleSignUp = e => {
        ...
        if (!passwordRegex.test(password)) {
            setErrorMessage('At least uppercase, one lowercase, one number one special charcter');
            return;
        }
    ...
    return (
        <div className="card bg-base-100 mx-auto mt-10 w-full max-w-sm shrink-0 shadow-2xl">
            ...
            </form>
            {
                ...
                text-red-500'>{errorMessage}</p>
            }
            {
                success && <p className=
                    'text-green-600'>Sign up is Success!</p>
            }
